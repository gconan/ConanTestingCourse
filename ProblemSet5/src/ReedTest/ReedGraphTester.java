...
public class ReedGraphTester {
    // tests for method "addEdge" in class "ReedGraph"
    @Test public void tae0() {
        ReedGraph g = new ReedGraph();
        g.addEdge(0, 1);
        //g.printGraph();
        assertEquals(g.toString(), "nodes: [0, 1]\nedges: {0=[1]}");
    }
    // your tests for method "addEdge" in class "ReedGraph" go here
    ...
    //   declared in the ReedGraph class as given in this homework
    // tests for method "reachable" in class "ReedGraph"
    ...
    // your tests for method "reachable" in class "ReedGraph" go here
